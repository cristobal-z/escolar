...
$pdf->SetFont('Arial','',12);
    ...
    $sql2 ="SELECT j.folio folio, a.id_alu matricula, a.nom nombre, j.fec_ fecha,
e.nom_esp especialidad, t.nom tutor,a.sem semestre, j.obs observaciones
FROM escolar.rep_justificantes j, escolar.alu a, escolar.especialidad e, escolar.tutores t
...
and j.id_alu = t.id_alu ";
  ...
  $pdf->Cell(275,9,utf8_decode('CONTROL DE REPORTES DE JUSTIFICANBTES GENERAL'),1,1,'C',1);
