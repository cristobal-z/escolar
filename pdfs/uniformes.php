...
FROM escolar.rep_uniformes j, escolar.alu a, escolar.especialidad e, escolar.tutores t
...
and j.id_alu = t.id_alu";
  ...
  $pdf->Cell(275,9,utf8_decode('CONTROL DE REPORTES DE UNIFORMES GENERAL'),1,1,'C',1);
